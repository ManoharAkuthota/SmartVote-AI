    ...
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-slate-950/95 backdrop-blur-xl border-t border-slate-800 px-2 py-1.5 pb-safe shadow-lg">
      <div className="flex items-center justify-around max-w-md mx-auto">
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 truncate max-w-[65px]">{t('nav_home')}</span>
        </Link>
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 truncate max-w-[65px]">{t('nav_elections')}</span>
        </Link>
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 truncate max-w-[65px]">{t('nav_verify')}</span>
        </Link>
        ...
        >
          <div className={`p-1 rounded-lg ${
            location.pathname.startsWith('/dashboard') || location.pathname.startsWith('/admin') || isActive('/login')
              ? isAdmin ? 'bg-purple-600/15' : 'bg-emerald-600/15'
              : ''
          }`}>
