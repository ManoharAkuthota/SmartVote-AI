...
import { Plus, Edit2, Trash2, Users, Calendar, AlertCircle, CheckCircle2, RefreshCw, X, Shield, LogOut } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-black text-slate-900 dark:text-white mt-1">Elections & Ballot Management</h1>
        </div>
